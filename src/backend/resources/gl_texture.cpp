...
void Backend::GPUTexture::uploadTextureData(Texture texture_data,TEXTURE_TYPE type){
    if(texture_data.containsTexture){
        glTexImage2D(GL_TEXTURE_2D,0,GL_RGB,texture_data.width,texture_data.height,0,GL_RGBA,GL_UNSIGNED_BYTE,texture_data.img_data.get());
